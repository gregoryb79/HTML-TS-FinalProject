...
export function init(hostTypeSelector, departmentSelector, hostSelector, dateSelector, timeSlotsList, selection, newAppointment) {
    ...
    function populateHosts(departmentType, hostType) {
